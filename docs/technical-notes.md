...
The 1.1.0 candidate passes 59 safe automated checks, strict controller concurrency compilation, and local artifact verification. It has not replaced the installed 1.0.2 app. See the [candidate results](verification-1.1.0.md) and [manual verification procedure](verification.md) for exact coverage and pending checks.
